      ...
      <nav className="bg-white dark:bg-custom-blue border-b-12 border-custom-yellow">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <button type="button" className="text-white bg-custom-green hover:bg-custom-green-hover focus:ring-4 focus:outline-none focus:ring-custom-green-hover font-medium rounded-lg text-sm px-4 py-2 flex items-center mr-3 md:mr-0 dark:bg-custom-green dark:hover:bg-custom-green-hover dark:focus:ring-custom-green-hover font-bold">
            ...
            <button data-collapse-toggle="navbar-cta" type="button" className="inline-flex items-center p-2 text-sm text-custom-yellow rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-custom-yellow dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-cta" aria-expanded="false">
          ...
          <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
            <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 rounded-lg dark:bg-custom-blue md:flex-row md:space-x-8 md:mt-0 md:bg-white dark:bg-custom-blue md:dark:bg-custom-blue">
              <li>
                <a href="#" className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-custom-yellow md:hover:bg-transparent md:hover:text-custom-yellow md:p-0 md:dark:hover:text-custom-yellow dark:text-white dark:hover:bg-gray-700 dark:hover:text-custom-yellow md:dark:hover:bg-transparent" aria-current="page">Início</a>
              </li>
              <li>
              ...
              <li>
                <Link href="/" className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-custom-yellow md:hover:bg-transparent md:hover:text-custom-yellow md:p-0 md:dark:hover:text-custom-yellow dark:text-white dark:hover:bg-gray-700 dark:hover:text-custom-yellow md:dark:hover:bg-transparent" aria-current="page">Produtos</Link>
              </li>
              <li>
                <Link href="/cadastro" className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-custom-yellow md:hover:bg-transparent md:hover:text-custom-yellow md:p-0 md:dark:hover:text-custom-yellow dark:text-white dark:hover:bg-gray-700 dark:hover:text-custom-yellow md:dark:hover:bg-transparent">Cadastro</Link>
              </li>
            </ul>
          </div>
        </div>
